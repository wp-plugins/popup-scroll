jQuery(document).ready( function ($) { 
	...
	$('#post').prepend(
	 '<h2 class="nav-tab-wrapper" id="chch-pusf-tabs"><a class="nav-tab nav-tab-active" href="#" title="Templates" data-target="chch-pusf-tab-1">Templates</a><a class="nav-tab" href="#" title="Settings" data-target="chch-pusf-tab-2">Settings</a></h2>'
	 );
